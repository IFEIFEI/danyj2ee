...
<script type="text/javascript">
    ...
    $('#mySelect').change(function()
    {
        ...
        var form = document.getElementById('infoCenter');

        for(var i=1;i<=select.value;i++)
        {
          //var part1=document.createElement("b");
          var part2=document.createElement("input");
          var textnode=document.createTextNode(i+" 期付款:");
          part2.setAttribute("type","text");
          part2.setAttribute("id","price"+i);
          part2.setAttribute("name","price"+i);
          var brNode=document.createElement("br");
          //form.appendChild(part1);
          form.appendChild(textnode);
          form.appendChild(part2);
          form.appendChild(brNode);
          form.appendChild(brNode);
        }

        //var a=document.createElement("b");
        var b=document.createTextNode("具体描述:");
        ...
        inputNode.setAttribute("id","tijiao");
        ...
        <hr/>
          <form action="artistAutionOrder" method="post" accept-charset="utf-8" class="examples part">
            ...
            <!--此处应该自动生成种类-->
                <div class="fields">
                               <span class="dk_wrap">
                                    <select name="kind" class="cs-select cs-skin-elastic" id="mySelect">
                                        <option value="" disabled selected data-class="disabled">分期付款次数</option>
